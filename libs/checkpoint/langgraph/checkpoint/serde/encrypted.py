...
class EncryptedSerializer(SerializerProtocol):
    ...
    def __init__(
        self, cipher: CipherProtocol, serde: SerializerProtocol = JsonPlusSerializer(), *, fallback_to_unencrypted: bool = True
    ) -> None:
        self.cipher = cipher
        self.serde = serde
        self.fallback_to_unencrypted = fallback_to_unencrypted
    ...
    def loads_typed(self, data: tuple[str, bytes]) -> Any:
        ...
        if "+" not in enc_cipher:
            if not self.fallback_to_unencrypted:
    ...
    def from_pycryptodome_aes(
        cls, serde: SerializerProtocol = JsonPlusSerializer(), *, fallback_to_unencrypted: bool = True, **kwargs: Any
    ) -> "EncryptedSerializer":
        ...
        return cls(PycryptodomeAesCipher(), serde, fallback_to_unencrypted=fallback_to_unencrypted)
