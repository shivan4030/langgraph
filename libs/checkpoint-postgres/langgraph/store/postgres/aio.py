...
class AsyncPostgresStore(AsyncBatchedBaseStore, BasePostgresStore[_ainternal.Conn]):
    ...
    async def setup(self) -> None:
        ...
        async with self._cursor() as cur:
            ...
            for v, migration_query in enumerate(
            ...
            if self.index_config:
                ...
                for v, migration in enumerate(
                    ...
                    migration_query = migration.sql
                    if migration.params:
                        params = {
                            k: val(self) if val is not None and callable(val) else val
                        ...
                        migration_query = migration_query % params
                    await cur.execute(migration_query)
                    await cur.execute(
